...
- 🤖 Machine Learning Engineering Intern, currently building **agentic AI systems, RAG pipelines & LangGraph workflows**
- 🔭 Working on end-to-end ML products — from model training to Docker deployment
- 💻 All my projects live at **[github.com/sarahoyar67890-gif](https://github.com/sarahoyar67890-gif)**
- 💬 Ask me about **ML / AI / LLM-powered apps / RAG systems**
- 📫 Reach me at **[sarahoyar67890@gmail.com](mailto:sarahoyar67890@gmail.com)**
...
### 🔍 ChurnLens
Customer churn prediction system — 4 ML models, SHAP explainability, K-Means segmentation, styled Streamlit dashboard.
...
### 🧭 DevLens AI
GitHub portfolio analyzer — FastAPI + Ollama + SQLite backend, containerized and deployed on Hugging Face Spaces.

`FastAPI` `Docker` `LLM` `SQLite`
...
### ✈️ AI Travel Agent
Conversational travel planning app with a glassmorphism UI, deployed on Streamlit Cloud.

`Python` `Streamlit` `LLM Agents`

</td>
<td width="50%">

### 🎙️ AI Mock Interview Platform
Practice interview platform simulating real interviewer flow with structured feedback.

`Python` `LangGraph` `HTML`
...
<!-- metrics.yml workflow keeps this image updated automatically, no third-party live API needed -->
![Metrics](https://raw.githubusercontent.com/sarahoyar67890-gif/sarahoyar67890-gif/main/github-metrics.svg)
...
<div align="center">
<img src="https://github-profile-trophy.vercel.app/?username=sarahoyar67890-gif&theme=radical&no-frame=true&row=1&column=6" alt="Trophies"/>
</div>
